...
<div class="container">
  ...
  <div class="tab-content">
    <div id="backups" class="container tab-pane fade"><br>
        <a class="btn btn-primary" href="/<?=ROOT_DIR?>/admin/create_backup">Create backup</a>
        <div class="row">
        <div class="col-md-12">
            <table class="table table-hover">
                    ...
                    <?php foreach($backups as $backup) { ?>
                      <tr>
                        ...
                        <td><a href="#"><small><?=$backup['name']?></small></a></td>
                        <td><a href="#"><small><?=$backup['path']?></small></a></td>
                        <td>
                            <a onclick="if(confirm('Are you sure you want to delete this backup?')) location.replace('/<?=ROOT_DIR?>/admin/delete_backup/<?=$backup['name']?>');" href="#"><i class="fa fa-trash"></i></a>
                            <a href="/<?=ROOT_DIR?>/admin/download_backup/<?=$backup['name']?>"><i class="fas fa-file-download"></i></a>
                            <a onclick="if(confirm('Are you sure you want to load this backup?')) location.replace('/<?=ROOT_DIR?>/admin/load_backup/<?=$backup['name']?>');" href="#"><i class="fas fa-upload"></i></a>
                        </td>
                      </tr>
                    <?php }?>                                       
                </tbody>
